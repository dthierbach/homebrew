class PostgisPostgresAT13 < Formula
  desc "Adds support for geographic objects to PostgreSQL@13"
  ...
  def install
    ...
    with_env("CPPFLAGS" => "-I/usr/local/opt/postgresql@13/include/postgresql/server") do
    ...
    # {buildpath}/stage/usr/local/Cellar/postgresql@13/{version}
    ...
    # files are in {buildpath}/stage/usr/local/opt/postgresql@13/share
    stage_path = File.join("stage", HOMEBREW_PREFIX, "opt", "postgresql@13")
  ...
  test do
    ...
    assert_match expected, (share/"postgresql@13/contrib/postgis-#{postgis_version}/postgis.sql").read
